...
import { COLORS, getRoleLabel } from '@/lib/colors'
  ...
  switch (message.type) {
    ...
    case 'assistant':
      return (
        ...
        >
          <div className="text-[9px] mb-1 font-semibold tracking-wider" style={{ color: COLORS.assistantLabel }}>{getRoleLabel('assistant', message.runtime)}</div>
